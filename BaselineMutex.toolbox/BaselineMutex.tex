...
\@x{}\moduleLeftDash\@xx{ {\MODULE} BaselineMutex}\moduleRightDash\@xx{}%
...
\@x{ {\ASSUME} Proc \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} pc ,\, mutex}%
\@pvspace{8.0pt}%
\@x{ Vars \.{\defeq} {\langle} pc ,\, mutex {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{PCs}:
...
\@x{}%
\@y{\@s{0}%
 \ensuremath{\@w{ncs}} : non-critical section
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{\@w{trying}} : attempting to acquire \ensuremath{mutex
}}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{\@w{cs}}\@s{12.5}: inside critical section
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{\@w{exit}} : leaving critical section and releasing
 \ensuremath{mutex
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} pc \.{=} [ i \.{\in} Proc \.{\mapsto}\@w{ncs} ]}%
\@x{\@s{16.4} \.{\land} mutex \.{=} 1}%
\@pvspace{8.0pt}%
\@x{ EnterTrying ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} pc [ i ] \.{=}\@w{ncs}}%
 \@x{\@s{16.4} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ i ]
 \.{=}\@w{trying} ]}%
\@x{\@s{16.4} \.{\land} mutex \.{'} \.{=} mutex}%
\@pvspace{8.0pt}%
\@x{ AcquireMutex ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} pc [ i ]\@s{7.90} \.{=}\@w{trying}}%
\@x{\@s{16.4} \.{\land} mutex \.{=} 1}%
 \@x{\@s{16.4} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ i ]
 \.{=}\@w{cs} ]}%
\@x{\@s{16.4} \.{\land} mutex \.{'} \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ LeaveCS ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{10.62} pc [ i ] \.{=}\@w{cs}}%
 \@x{\@s{16.4} \.{\land}\@s{10.62} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ i ]
 \.{=}\@w{exit} ]}%
\@x{\@s{16.4} \.{\land}\@s{10.62} mutex \.{'} \.{=} mutex}%
\@pvspace{8.0pt}%
\@x{ ReleaseMutex ( i ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} pc [ i ]\@s{7.90} \.{=}\@w{exit}}%
\@x{\@s{16.4} \.{\land} mutex \.{=} 0}%
 \@x{\@s{16.4} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ i ]
 \.{=}\@w{ncs} ]}%
\@x{\@s{16.4} \.{\land} mutex \.{'} \.{=} 1}%
\@pvspace{8.0pt}%
\@x{ ProcStep ( i ) \.{\defeq}}%
\@x{\@s{16.4} EnterTrying ( i )}%
\@x{\@s{16.4} \.{\lor} AcquireMutex ( i )}%
\@x{\@s{16.4} \.{\lor} LeaveCS ( i )}%
\@x{\@s{16.4} \.{\lor} ReleaseMutex ( i )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \E\, i \.{\in} Proc \.{:} ProcStep ( i )}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} pc \.{\in} [ Proc \.{\rightarrow} \{\@w{ncs}
 ,\,\@w{trying} ,\,\@w{cs} ,\,\@w{exit} \} ]}%
\@x{\@s{16.4} \.{\land}\@s{9.74} mutex \.{\in} \{ 0 ,\, 1 \}}%
\@pvspace{8.0pt}%
\@x{ InCS \.{\defeq}}%
\@x{\@s{16.4} \{ i \.{\in} Proc \.{:} pc [ i ] \.{=}\@w{cs} \}}%
\@pvspace{8.0pt}%
\@x{ MutualExclusion \.{\defeq}}%
\@x{\@s{16.4} Cardinality ( InCS ) \.{\leq} 1}%
\@pvspace{8.0pt}%
\@x{ Spec \.{\defeq}}%
\@x{\@s{16.4} Init \.{\land} {\Box} [ Next ]_{ Vars}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
